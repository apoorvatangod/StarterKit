...
public class GameOfLife extends JPanel{
	...
	private static final Point GRID_SIZE = new Point(50, 50);
	...
	public void paint(Graphics g) {
		...
		int cellWidth = frameWidth / GRID_SIZE.y;
		int cellHeight = frameHeight / GRID_SIZE.x;
		for(Field field : fields){
			int x = field.getPosition().x * cellWidth;
			int y = field.getPosition().y * cellHeight;
			if(field.getCellState() == CellState.ALIVE.getValue()){
